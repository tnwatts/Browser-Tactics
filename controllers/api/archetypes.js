...
async function usersList(req,res){
  const usersArchetypes = await Archetype.find({owners: req.params.id })
  res.json(usersArchetypes)
}
...
async function seed() {
    ...
    const items = await Archetype.create([
      {name: 'Ug', archetype: 'Barbarian', hp: 70, attackMultiplier: 1.4, movement: 4, cost: 0, image: "https://i.imgur.com/uFcF0FK.png"},
      ...
      {name: 'Ned', archetype: 'Rat King' , hp: 60, range: 4, attackMultiplier: 1.3, movement: 6, cost: 0, image: "https://i.imgur.com/rq39A3m.png"}
    ]);
    console.log(items)
  }
