...
export default function StatusWindow({ game, setGame,  user, startGame }) {
    ...
    <>
      ...
      >
        ...
        <div className="offcanvas-body row large light-background dark-text p-4">
            ...
            <h5 className="text-dark small mx-auto my-1 pb-1">{game.p1.units[0].name}</h5>
            <div className="selector " style={{ backgroundImage: `url(${game.p1.units[0].image}`}} ></div>
            <h6 className="darkest-text mx-auto lifted rounded-2 light-background">The {game.p1.units[0].archetype}</h6>
            </div>
            ...
            <div className="selector"  style={{ backgroundImage: `url(${game.p1.units[1].image}`}} ></div>
            <h6 className="darkest-text mx-auto lifted rounded-2 light-background">{game.p1.units[1].archetype}</h6>
            </div>
            <div className="col-2 mx-3 lifted light-backgroundg unit-wrap border border-1 border-warning rounded-2">
            <h5 className="text-dark mx-auto my-1">{game.p1.units[2].archetype}</h5>
            ...
            <div className="col-4 mx-auto lifted py-5 my-2 light-background darken-area border border-2 border-warning rounded-2 ">
                ...
                (!game.phase === 0) ?
                  ...
                  <button onClick={startGame} data-bs-dismiss="offcanvas" aria-label="Close" className="col-12 btn dark-background btn-warning btn-outline-warning  my-5"> START </button>
                  </div>
                  :
                  <>
